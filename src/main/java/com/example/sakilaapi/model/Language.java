...
/**
 * com.example.sakilaapi.model.Language generated by hbm2java
 */
@Entity
@Table(name="language"
    ,catalog="sakila"
...
public class Language  implements java.io.Serializable {
    ...
    public Language(String name, Timestamp lastUpdate, Set filmsForLanguageId, Set filmsForOriginalLanguageId) {
       this.name = name;
       this.lastUpdate = lastUpdate;
