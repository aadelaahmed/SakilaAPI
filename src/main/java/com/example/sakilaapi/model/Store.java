...
/**
 * com.example.sakilaapi.model.Store generated by hbm2java
 */
@Entity
@Table(name="store"
    ,catalog="sakila"
...
public class Store  implements java.io.Serializable {
    ...
    public Store(Staff staff, Address address, Timestamp lastUpdate, Set staffs, Set inventories, Set customers) {
       this.staff = staff;
       this.address = address;
       this.lastUpdate = lastUpdate;
       this.staffs = staffs;
